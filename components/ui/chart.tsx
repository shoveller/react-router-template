  ...
  (
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      if (!labelKey && typeof label === 'string') {
        const labelValue = config[label as keyof typeof config]?.label || label
      ...
      const configValue = itemConfig?.label

      if (labelFormatter) {
        return (
          <div className={cn('font-medium', labelClassName)}>
            {labelFormatter(configValue, payload)}
          </div>
        )
      }
      ...
      return (
        <div className={cn('font-medium', labelClassName)}>{configValue}</div>
      )
    }, [
      label,
      labelFormatter,
                    ...
                    <>
                            ...
                            <div
                              className={cn(
                                ...
                                bg-[--color-bg]`,
                                {
                                  ...
                                  bg-transparent`]: indicator === 'dashed',
                      ...
                      <div
                        className={(() => {
                          ...
                          if (nestLabel) {
                            return cn(baseClass, 'items-end')
                          }

                          return cn(baseClass, 'items-center')
                        })()}
                      >
                        <div className="grid gap-1.5">
                          {(() => {
